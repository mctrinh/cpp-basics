...
int main(){
	...
	std::cout << "&number : " << &number << std::endl;  // address of number in hec
    ...
    // Access - Print out
    std::cout << "number : " << number << std::endl;
	std::cout << "&number : " << &number << std::endl;   // same address
    std::cout << std::endl;
    ...
    *p_number1 = 432;
	std::cout << "p_number1 : " << p_number1 << std::endl;  // same address
    ...
    int number2 {56};
    p_number1 = &number2;
    std::cout << "p_number1 :" << p_number1 << std::endl;       // different address
