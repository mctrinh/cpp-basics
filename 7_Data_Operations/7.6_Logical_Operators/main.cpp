...
int main(){
    ...
    std::cout << std::boolalpha;    // true, false format
    ...
    //       A single false operand will drag the entire expressions to evaluating false.
    std::cout << std::endl;
    ...
    //      A single true operand will push the entire expressions to evaluating true.
    std::cout << std::endl;
