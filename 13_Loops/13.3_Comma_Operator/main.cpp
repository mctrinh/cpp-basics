...
int main(){
    ...
    std::cout << "number1 : " << number1 << std::endl; // 60 = 10 * 6
    std::cout << "number2 : " << number2 << std::endl; // 20 = unchanged as unused expression
    std::cout << "number3 : " << number3 << std::endl; // 33 = 25 + 8
    std::cout << "result : " <<  result << std::endl; // 33 = last expression?
